...
class SignIn extends Component {
	...
	submitHandler = (event) => {
		...
		this.props.eduvedaSignIn(this.state.controls.email.value, this.state.controls.password.value);
	}
					...
					<div className="popup_box ">
						<div className="popup_inner">
							...
							<form onSubmit={this.submitHandler}>
								...
								<div className="col">
									<button className="google btn" onClick={this.props.onGoogleLogin}>
...
const mapDispatchToProps = dispatch => {
	return {
		eduvedaSignIn: (email, password) => dispatch(actions.eduvedaSignIn(email, password)),
		onGoogleLogin: () => dispatch(actions.startGoogleLogin())
	};
};
